    ...
    public class RawInputHandler : MonoBehaviour
    {
        ...
        private static void ProcessRawInput(IntPtr lParam)
        {
            ...
            if (header.dwType == 0)
            {
                ...
                if ((mouse.usButtonFlags & 0x0001) != 0) // 左键按下
                {
                    if (header.hDevice == firstMouseDevice)
                    {
                ...
                if ((mouse.usButtonFlags & 0x0002) != 0) // 左键松开
                {
                    if (header.hDevice == firstMouseDevice)
                    {
                ...
                if ((mouse.usButtonFlags & 0x0004) != 0) // 右键按下
                {
                    if (header.hDevice == firstMouseDevice)
                    {
                ...
                if ((mouse.usButtonFlags & 0x0008) != 0) // 右键松开
                {
                    if (header.hDevice == firstMouseDevice)
                    {
                ...
                if ((mouse.usButtonFlags & 0x0010) != 0) // 中键按下
                {
                    if (header.hDevice == firstMouseDevice)
                    {
                ...
                if ((mouse.usButtonFlags & 0x0020) != 0) // 中键松开
                {
                    if (header.hDevice == firstMouseDevice)
                    {
                ...
                if ((mouse.usButtonFlags & 0x0400) != 0) // 垂直滚轮
                {
                    if (header.hDevice == firstMouseDevice)
                    {
